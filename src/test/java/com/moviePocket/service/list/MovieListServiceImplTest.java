...
//
//        // Test service method
//        ResponseEntity<ListDTO> response = movieListService.setList(email, title, content);
//
//        // Assertions
...
//
//        ResponseEntity<List<ListDTO>> responseEntity = movieListService.getAllListsContainingMovie(idMovie);
//
...
//        when(listGenreRepository.getAllByMovieList(any())).thenReturn(new ArrayList<>());
//
//        ResponseEntity<List<ListDTO>> responseEntity = movieListService.getTop10LatestLists();
//
//        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
//        assertNotNull(responseEntity.getBody());
//        // Add more assertions based on your expectations
...
//        when(listGenreRepository.getAllByMovieList(any())).thenReturn(new ArrayList<>());
//
//        ResponseEntity<List<ListDTO>> responseEntity = movieListService.getTop10LikedLists();
//
//        assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
//        assertNotNull(responseEntity.getBody());
//        assertEquals(2, responseEntity.getBody().size());
