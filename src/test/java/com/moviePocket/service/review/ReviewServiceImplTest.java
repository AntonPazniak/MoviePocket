...
//
//        ResponseEntity<List<ReviewDTO>> response = reviewService.getAllByIdPost(idPost);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(reviews.size(), response.getBody().size());
//    }
...
//
//        ResponseEntity<List<ReviewDTO>> response = reviewService.getAllReviewsByUser(email);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals(reviews.size(), response.getBody().size());
//    }
